...
pygame.display.set_caption('Made by UGT- A car race')
...
drawText('PRESS ANY KEY TO START THE GAME!- Made by UGT', font, windowSurface, (WINDOWWIDTH / 5) - 137, (WINDOWHEIGHT / 3)+80)
